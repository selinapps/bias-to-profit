-- SAFE VERSION: Fix calculation issues without dropping materialized view
-- This version avoids the dependency issue by updating the materialized view in place
...
-- 4. Create function to get best trading hours (fixed)
...
-- 5. Create function to get weekly summary (fixed)
...
-- 6. Create function to get daily performance (fixed)
...
-- 8. Add performance indexes (safe - won't cause conflicts)
...
-- 9. Create trigger to auto-refresh materialized view
...
-- 10. Create function to manually refresh all performance data
...
-- 11. Add comments explaining the fixes
...
-- 12. Refresh the existing materialized view with correct data
REFRESH MATERIALIZED VIEW public.daily_performance_metrics;
