...
const CACHE_NAME = 'bias-to-profit-v4';
const OFFLINE_URL = '/bias-to-profit/offline.html';

// Assets to cache for offline functionality
const CACHE_ASSETS = [
  '/bias-to-profit/',
  '/bias-to-profit/offline.html',
  '/bias-to-profit/favicon.ico',
  '/bias-to-profit/placeholder.svg',
  '/bias-to-profit/robots.txt'
];
