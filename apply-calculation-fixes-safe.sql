-- Safe version of calculation fixes that avoids immutable function errors
-- Apply this if you get the 42P17 error
...
-- 7. Add simple indexes for better performance (avoiding immutable function issues)
