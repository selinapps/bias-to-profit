-- Complete migration: Create trades table and apply performance optimizations (FIXED VERSION)
-- This script ensures the trades table exists before applying optimizations
-- Fixed: Removed RLS on materialized view which is not supported
...
-- Step 12: Create a secure view for daily performance metrics (instead of RLS on materialized view)
...
-- Step 13: Create optimized database functions
